...
visitors = Table('visitors', post_meta,
    ...
    Column('action', String(length=64), default=ColumnDefault('just guest')),
    Column('arrival_time', String(length=20), default=ColumnDefault('00:00:0000:00:00:00')),
    Column('leaving_time', String(length=20), default=ColumnDefault('00:00:0000:00:00:00')),
    Column('price', Integer, default=ColumnDefault(0)),
)
